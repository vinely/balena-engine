...
func (s *DockerDaemonSuite) TestCleanupMountsAfterDaemonAndContainerKill(c *check.C) {
	...
	// kill the container
	icmd.RunCommand(ctrBinary, "--address", "unix:///var/run/docker/libcontainerd/balena-containerd.sock", "containers", "kill", id).Assert(c, icmd.Success)
...
func (s *DockerDaemonSuite) TestDaemonRestartWithKilledRunningContainer(t *check.C) {
	...
	// kill the container
	icmd.RunCommand(ctrBinary, "--address", "unix:///var/run/docker/libcontainerd/balena-containerd.sock", "containers", "kill", cid).Assert(t, icmd.Success)
...
func (s *DockerDaemonSuite) TestDaemonRestartWithUnpausedRunningContainer(t *check.C) {
	...
	result := icmd.RunCommand(
		ctrBinary,
		"--address", "unix:///var/run/docker/libcontainerd/balena-containerd.sock",
...
func (s *DockerDaemonSuite) TestDaemonLogOptions(c *check.C) {
	c.Skip("Syslog and json-file aren't supported")
